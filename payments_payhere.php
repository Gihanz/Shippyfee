...
define('PAYPAL_NOTIFY_URL', 'https://shippyfee.com/payhere-notify.php');
...
<div class="container-xxl">
	<div class="col-md-3" style="background-color: #292929; text-align: -webkit-center; height: 560px; border-style: solid">
		<form method="post" action="<?php echo PAYHERE_URL; ?>" id="subscription_0" style="display: none">   
			<input type="hidden" name="merchant_id" value="<?php echo MERCHANT_ID; ?>">    <!-- Replace your Merchant ID -->
			<input type="hidden" name="return_url" value="<?php echo PAYPAL_RETURN_URL; ?>">
			<input type="hidden" name="cancel_url" value="<?php echo PAYPAL_CANCEL_URL; ?>">
	...
	<div class="col-md-3" style="background-color: #292929; text-align: -webkit-center; height: 600px; border-style: solid">
		<form method="post" action="<?php echo PAYHERE_URL; ?>" id="subscription_1" style="display: none">   
			<input type="hidden" name="merchant_id" value="<?php echo MERCHANT_ID; ?>">    <!-- Replace your Merchant ID -->
			<input type="hidden" name="return_url" value="<?php echo PAYPAL_RETURN_URL; ?>">
			<input type="hidden" name="cancel_url" value="<?php echo PAYPAL_CANCEL_URL; ?>">
			<input type="hidden" name="notify_url" value="<?php echo PAYPAL_NOTIFY_URL; ?>">  
	...
	<div class="col-md-3" style="background-color: #292929; text-align: -webkit-center; height: 600px; border-style: solid">
		<form method="post" action="<?php echo PAYHERE_URL; ?>" id="subscription_2" style="display: none">   
			<input type="hidden" name="merchant_id" value="<?php echo MERCHANT_ID; ?>">    <!-- Replace your Merchant ID -->
			<input type="hidden" name="return_url" value="<?php echo PAYPAL_RETURN_URL; ?>">
			<input type="hidden" name="cancel_url" value="<?php echo PAYPAL_CANCEL_URL; ?>">
			<input type="hidden" name="notify_url" value="<?php echo PAYPAL_NOTIFY_URL; ?>">  
	...
	<div class="col-md-3" style="background-color: #292929; text-align: -webkit-center; height: 560px; border-style: solid">
		<form method="post" action="<?php echo PAYHERE_URL; ?>" id="subscription_3" style="display: none">   
			<input type="hidden" name="merchant_id" value="<?php echo MERCHANT_ID; ?>">    <!-- Replace your Merchant ID -->
			<input type="hidden" name="return_url" value="<?php echo PAYPAL_RETURN_URL; ?>">
			<input type="hidden" name="cancel_url" value="<?php echo PAYPAL_CANCEL_URL; ?>">
			<input type="hidden" name="notify_url" value="<?php echo PAYPAL_NOTIFY_URL; ?>">  
